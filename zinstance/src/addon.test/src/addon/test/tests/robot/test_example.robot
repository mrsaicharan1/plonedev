...
#
#  $ bin/test -s addon.test -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src addon.test.testing.ADDON_TEST_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/addon/test/tests/robot/test_example.robot
#
